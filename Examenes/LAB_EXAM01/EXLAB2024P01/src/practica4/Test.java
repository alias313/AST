...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        SimNet_FullDuplex net = new SimNet_FullDuplex(0.5, 0);
...
class HostSnd implements Runnable {
    ...
    public void run() {
        ...
        //fes servir els ports apropiats
        new Sender(new TSocket(proto, HostSnd.PORT1, HostRcv.PORT), 10, 11, 100).start();
        new Sender(new TSocket(proto, HostSnd.PORT2, HostRcv.PORT), 10, 11, 100).start();
    }
}
